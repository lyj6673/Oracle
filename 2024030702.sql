2024-0307-02)숫자자료 타입
 ...
 컬럼명 NUMBER[(정밀도|*[스케일])]
   ...
   . '스케일' : 소숫점 이하의 자리수
   . '스케일'이 생략되면 '0'으로 간주
   . 저장은 '스케일'+1번째 자리에서 반올림하여 '스케일'번째까지 저장(정수자리 수 : 정밀도-스케일)
   .'스케일'이 음수이면 정수 자리수에서 반올림 함
...
------------------------------------------------------
  ...
  CREATE TABLE TEMP05(
    ...
    INSERT INTO TEMP05 VALUES(12345.6789,12345.6789,45.6789,12345.6789,12345.6789,
