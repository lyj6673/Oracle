2024-0308-01)날짜 자료형
 - 년, 월, 일, 시, 분, 초의 값을 보관
 - 덧셈과 뺄셈을 대상이 될 수 있음
 - 기본 제공 함수로 SYSDATE, SYSTIMESTAMP 가 제공됨
 - DATE, TIMESTAMP
 ...
 사용 예)
    ...
    INSERT INTO TEMP06 VALUES('20240308', TO_DATE('20240308151650','YYYYMMDDHH24MISS'));
...
2. TIMESTAMP
 - 10억분의 1초 단위의 정교한 시각정보를 년월일 정보와 함께 저장
 - 시간대(TIMEZONE)정보 저장
 - TIMESTAMP 타입에 저장하는 날짜함수는 SYSTIMESTAMP 임
 (사용 형식)
